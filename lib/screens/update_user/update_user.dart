...
class MyCustomForm extends StatefulWidget {
  final String? id;
  const MyCustomForm({super.key, this.id});

  @override
  MyCustomFormState createState() {
    return MyCustomFormState(id: id);
  }
}
...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  MyCustomFormState({required this.id});
                    ...
                    try {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                            ...
                            content: Text(
                                'User Updated: ${newUser[0]["first_name"]} ${newUser[0]["last_name"]}')),
                      );
                    } catch (err) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
